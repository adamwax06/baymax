...
export const METRICS: readonly MetricDef[] = [
  ...
  { name: "dietary_energy", hkType: "HKQuantityTypeIdentifierDietaryEnergyConsumed", kind: "quantity", unit: "kcal", aggregation: "sum", description: "Dietary energy consumed (kcal), including Baymax plan-derived intake mirrored into Apple Health" },
  { name: "dietary_protein", hkType: "HKQuantityTypeIdentifierDietaryProtein", kind: "quantity", unit: "g", aggregation: "sum", description: "Dietary protein consumed (g)" },
  { name: "dietary_carbohydrates", hkType: "HKQuantityTypeIdentifierDietaryCarbohydrates", kind: "quantity", unit: "g", aggregation: "sum", description: "Dietary carbohydrates consumed (g)" },
  { name: "dietary_fat", hkType: "HKQuantityTypeIdentifierDietaryFatTotal", kind: "quantity", unit: "g", aggregation: "sum", description: "Total dietary fat consumed (g)" },
  { name: "dietary_fiber", hkType: "HKQuantityTypeIdentifierDietaryFiber", kind: "quantity", unit: "g", aggregation: "sum", description: "Dietary fiber consumed (g)" },
  { name: "dietary_calcium", hkType: "HKQuantityTypeIdentifierDietaryCalcium", kind: "quantity", unit: "mg", aggregation: "sum", description: "Dietary calcium consumed (mg)" },
  { name: "dietary_iron", hkType: "HKQuantityTypeIdentifierDietaryIron", kind: "quantity", unit: "mg", aggregation: "sum", description: "Dietary iron consumed (mg)" },
  { name: "dietary_magnesium", hkType: "HKQuantityTypeIdentifierDietaryMagnesium", kind: "quantity", unit: "mg", aggregation: "sum", description: "Dietary magnesium consumed (mg)" },
  { name: "dietary_potassium", hkType: "HKQuantityTypeIdentifierDietaryPotassium", kind: "quantity", unit: "mg", aggregation: "sum", description: "Dietary potassium consumed (mg)" },
  { name: "dietary_sodium", hkType: "HKQuantityTypeIdentifierDietarySodium", kind: "quantity", unit: "mg", aggregation: "sum", description: "Dietary sodium consumed (mg)" },
  { name: "dietary_zinc", hkType: "HKQuantityTypeIdentifierDietaryZinc", kind: "quantity", unit: "mg", aggregation: "sum", description: "Dietary zinc consumed (mg)" },
  { name: "dietary_vitamin_d", hkType: "HKQuantityTypeIdentifierDietaryVitaminD", kind: "quantity", unit: "mcg", aggregation: "sum", description: "Dietary vitamin D consumed (mcg)" },
  { name: "dietary_vitamin_c", hkType: "HKQuantityTypeIdentifierDietaryVitaminC", kind: "quantity", unit: "mg", aggregation: "sum", description: "Dietary vitamin C consumed (mg)" },
  ...
  { name: "blood_glucose", hkType: "HKQuantityTypeIdentifierBloodGlucose", kind: "quantity", unit: "mg/dL", aggregation: "latest", description: "Blood glucose (mg/dL), including reviewed clinical-lab backfills" },
  { name: "body_temperature", hkType: "HKQuantityTypeIdentifierBodyTemperature", kind: "quantity", unit: "degC", aggregation: "latest", description: "Body temperature (degrees Celsius), including clinical-record backfills" },
  { name: "blood_pressure_systolic", hkType: "HKQuantityTypeIdentifierBloodPressureSystolic", kind: "quantity", unit: "mmHg", aggregation: "latest", description: "Systolic blood pressure (mmHg), stored with its diastolic partner as a HealthKit correlation when written by Baymax" },
  { name: "blood_pressure_diastolic", hkType: "HKQuantityTypeIdentifierBloodPressureDiastolic", kind: "quantity", unit: "mmHg", aggregation: "latest", description: "Diastolic blood pressure (mmHg), stored with its systolic partner as a HealthKit correlation when written by Baymax" },
  { name: "height", hkType: "HKQuantityTypeIdentifierHeight", kind: "quantity", unit: "m", aggregation: "latest", description: "Height (meters), including clinical-record backfills" },
