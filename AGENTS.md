...
| `docs/nutrition.md` | The nutrition loop: `data/goals.json` (profile + body-weight goal) and `data/nutrition.json` (daily kcal log) drive adaptive TDEE-based calorie/protein targets via `health nutrition` / `health_nutrition` |
