...
| `apps/server` | Hono server. Ingest: `POST /v1/ingest/{samples,workouts}`. App reads: `GET /v1/{today,overview,nutrition,log/template,backfill/bodyweight}`. App writes: `POST /v1/log/workout` (appends weights.json + re-imports). `GET /v1/ping` |
