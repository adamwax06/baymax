...
| `docs/weights.md` | Format of `data/weights.json` — the hand-edited source of truth for gym sessions + manual body weight (committed on purpose; editable via the GitHub app, then `git pull` + import) |
